...
2. Setup first [project](https://console.cloud.google.com/) if you haven't already
    * eg. "de-zoomcamp", and note down the "Project ID" (we'll use this later when deploying infra with TF)
3. Setup [service account & authentication](https://cloud.google.com/docs/authentication/getting-started) for this project
    * Grant `Viewer` role to begin with.
4. Download the key and put it to some location, e.g. `.gc/<your key>.json`
...
2. Enable these APIs for your project (choice your project in dropdown list):
